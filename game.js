...
class Game {
    ...
    nextRoom() {
        ...
        const rooms = ['egypt', 'renaissance', 'space', 'wednesday', 'strangerthings'];
    ...
    updateRoomSelection() {
        ['egypt', 'renaissance', 'space', 'wednesday', 'strangerthings'].forEach(room => {
    ...
    checkAchievements() {
        const achievements = [
            ...
            { id: 'complete-all', name: 'Time Master', condition: () => this.progress.totalEscapes >= 5 }
        ];
